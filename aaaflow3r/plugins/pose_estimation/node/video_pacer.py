...
from aaaflow3r.core.streaming.abc.transform import Transform, TDataIn, TDataOut
...
class VideoPacer(Transform[VideoFormat, VideoFrame, VideoFormat, VideoFrame]):
    ...
    def transform_observable(self, obs: rx.Observable[TDataIn]) -> rx.Observable[TDataOut]:
        return obs.pipe(preview_pace(self._period, self._buffer_size))

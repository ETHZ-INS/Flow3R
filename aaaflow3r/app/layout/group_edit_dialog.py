...
################################################################################
## Form generated from reading UI file 'GroupEditDialog.ui'
##
...
class Ui_GroupEditDialog(object):
    def setupUi(self, GroupEditDialog):
        ...
        sizePolicy.setHeightForWidth(GroupEditDialog.sizePolicy().hasHeightForWidth())
        GroupEditDialog.setSizePolicy(sizePolicy)
        GroupEditDialog.setMinimumSize(QSize(0, 0))
        GroupEditDialog.setMaximumSize(QSize(16777215, 16777215))
        GroupEditDialog.setModal(False)
        self.verticalLayout = QVBoxLayout(GroupEditDialog)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setSizeConstraint(QLayout.SetMinAndMaxSize)
        self.label = QLabel(GroupEditDialog)
        self.label.setObjectName(u"label")
        self.label.setTextFormat(Qt.MarkdownText)

        self.verticalLayout.addWidget(self.label)

        self.frm_recording_configuration = QFrame(GroupEditDialog)
        ...
        self.btnbox_buttons = QDialogButtonBox(GroupEditDialog)
        ...
        self.retranslateUi(GroupEditDialog)
        self.btnbox_buttons.accepted.connect(GroupEditDialog.accept)
        self.btnbox_buttons.rejected.connect(GroupEditDialog.reject)

        QMetaObject.connectSlotsByName(GroupEditDialog)
    # setupUi

    def retranslateUi(self, GroupEditDialog):
        GroupEditDialog.setWindowTitle(QCoreApplication.translate("GroupEditDialog", u"Configure Group", None))
        self.label.setText(QCoreApplication.translate("GroupEditDialog", u"### Group Settings", None))
        self.label_3.setText(QCoreApplication.translate("GroupEditDialog", u"Name:", None))
        self.txt_recording_name.setText(QCoreApplication.translate("GroupEditDialog", u"Group 1", None))
        self.label_2.setText(QCoreApplication.translate("GroupEditDialog", u"Recording Mode:", None))
        self.dpd_recording_mode.setItemText(0, QCoreApplication.translate("GroupEditDialog", u"Timed", None))
        self.dpd_recording_mode.setItemText(1, QCoreApplication.translate("GroupEditDialog", u"Manual", None))

...
:: pyside6-uic "ui/GrimaceResultsWidget.ui" -o "app/layout/grimace_results_widget.py"
...
:: pyside6-uic "ui/PoseEstimationConfigurationDialog.ui" -o "flow3r/pose_estimation/layout/pose_estimation_configuration_dialog.py"
:: pyside6-uic "ui/GrimaceAnalysisConfigurationDialog.ui" -o "app/layout/grimace_analysis_configuration_dialog.py"
...
:: pyside6-uic "ui/PipelineEditDialog.ui" -o "flow3r/app/layout/pipeline_edit_dialog.py"

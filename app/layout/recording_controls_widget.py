...
class Ui_RecordingControlsWidget(object):
    def setupUi(self, RecordingControlsWidget):
        ...
        RecordingControlsWidget.setFrameShape(QFrame.NoFrame)
        self.verticalLayout = QVBoxLayout(RecordingControlsWidget)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.lbl_recording_name = QLabel(RecordingControlsWidget)
        self.lbl_recording_name.setObjectName(u"lbl_recording_name")
        sizePolicy.setHeightForWidth(self.lbl_recording_name.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, RecordingControlsWidget):
        ...
        self.lbl_recording_name.setText(QCoreApplication.translate("RecordingControlsWidget", u"Recording 1", None))

...
class Ui_WelfareRecorder(object):
    def setupUi(self, WelfareRecorder):
        ...
        self.action_add_source = QAction(WelfareRecorder)
        self.action_add_source.setObjectName(u"action_add_source")
        self.action_list_sources = QAction(WelfareRecorder)
        self.action_list_sources.setObjectName(u"action_list_sources")
        self.action_add_group = QAction(WelfareRecorder)
        self.action_add_group.setObjectName(u"action_add_group")
        self.action_list_groups = QAction(WelfareRecorder)
        self.action_list_groups.setObjectName(u"action_list_groups")
        ...
        self.action_list_pipelines = QAction(WelfareRecorder)
        self.action_list_pipelines.setObjectName(u"action_list_pipelines")
        ...
        self.menuCameras.addAction(self.action_list_sources)
        self.menuCameras.addAction(self.action_add_source)
        self.menuProcessing.addAction(self.action_list_pipelines)
        ...
        self.menuGroups.addAction(self.action_list_groups)
    ...
    def retranslateUi(self, WelfareRecorder):
        ...
        self.action_add_source.setText(QCoreApplication.translate("WelfareRecorder", u"Add Source", None))
        self.action_list_sources.setText(QCoreApplication.translate("WelfareRecorder", u"Sources...", None))
        self.action_add_group.setText(QCoreApplication.translate("WelfareRecorder", u"Add Group", None))
        self.action_list_groups.setText(QCoreApplication.translate("WelfareRecorder", u"Groups...", None))
        ...
        self.action_list_pipelines.setText(QCoreApplication.translate("WelfareRecorder", u"Processing Pipelines...", None))
        ...
        self.menuCameras.setTitle(QCoreApplication.translate("WelfareRecorder", u"Sources", None))
        self.menuProcessing.setTitle(QCoreApplication.translate("WelfareRecorder", u"Pipelines", None))
        self.menuVariables.setTitle(QCoreApplication.translate("WelfareRecorder", u"Placeholders", None))
        self.menuGroups.setTitle(QCoreApplication.translate("WelfareRecorder", u"Groups", None))
    # retranslateUi

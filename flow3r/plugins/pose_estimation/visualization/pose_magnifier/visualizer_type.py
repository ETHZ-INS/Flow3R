...
from flow3r.plugins.pose_estimation.visualization.pose_magnifier.widget import PoseMagnifierWidget


class PoseMagnifierVisualizerType(IVisualizerType):
    @property
    def name(self) -> str:
        return "Pose Magnifier"

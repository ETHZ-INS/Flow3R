...
class Ui_WelfareRecorder(object):
    def setupUi(self, WelfareRecorder):
        ...
        self.action_list_placeholders = QAction(WelfareRecorder)
        self.action_list_placeholders.setObjectName(u"action_list_placeholders")
        self.action_list_pipelines = QAction(WelfareRecorder)
        self.action_list_pipelines.setObjectName(u"action_list_pipelines")
        self.action_superuser_mode = QAction(WelfareRecorder)
        self.action_superuser_mode.setObjectName(u"action_superuser_mode")
        self.action_set_placeholder_values = QAction(WelfareRecorder)
        self.action_set_placeholder_values.setObjectName(u"action_set_placeholder_values")
        self.action_new_project = QAction(WelfareRecorder)
        ...
        self.menuFile.addAction(self.action_superuser_mode)
        ...
        self.menuVariables.addAction(self.action_list_placeholders)
        self.menuVariables.addAction(self.action_add_placeholder)
        self.menuVariables.addAction(self.action_set_placeholder_values)
    ...
    def retranslateUi(self, WelfareRecorder):
        ...
        self.action_list_placeholders.setText(QCoreApplication.translate("WelfareRecorder", u"Placeholders...", None))
        self.action_list_pipelines.setText(QCoreApplication.translate("WelfareRecorder", u"Processing Pipelines...", None))
        self.action_superuser_mode.setText(QCoreApplication.translate("WelfareRecorder", u"Super User Mode", None))
        self.action_set_placeholder_values.setText(QCoreApplication.translate("WelfareRecorder", u"Set Placeholder Values", None))
        self.action_new_project.setText(QCoreApplication.translate("WelfareRecorder", u"New Project", None))
